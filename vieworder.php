                            ...
                            <table class="table mb-5">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="productdetails.php?ID=<?php echo $pId ?>" style="text-decoration: none;"><?php echo $prod_row['pName'] ." ".$prod_row['pSize']; ?></a>
                                            </td>
                                ...
                                <tfooter>
                                        ...
                                        <tr>
                                            ...
                                            <th></th>
                                            <th>Date Placed:</th>
                                            <th class="text-end"><?php echo date("M d, Y h:i A", strtotime($ord_row['timestamps'])); ?></th>
                                        </tr>
                                </tfooter>
